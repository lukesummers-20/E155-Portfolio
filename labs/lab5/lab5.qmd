...
The design was succesfull in acheiving its desired functionality. The video above shows the design reading the speed of the motor at various voltages. The design becomes more accurate as the speed is slowed, but is still accurate to around the tenth of a rotation per second through a +20V input. When the direction of the motor was switched, the design succesfully displayed a negative speed. 

## Conclusion
The MCU succesfully read a quadrapture encoder to read the speed of the connected motor. I spent 13 hours on this lab. 